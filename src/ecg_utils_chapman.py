...
DATA_DIR = os.path.expanduser("~/ecg_data/chapman/chapman_shaoxing")

# 7 well-supported Chapman rhythm classes: (SNOMED code, short name)
RHYTHM = [("426783006","SR"),("164889003","AFIB"),("426177001","SB"),
          ("427084000","ST"),("164890007","AF"),("426761007","SVT"),
          ("713422000","AT")]
CODES=[c for c,_ in RHYTHM]
CHAPMAN_CLASSES=[n for _,n in RHYTHM]
...
def get_chapman_dataloaders(batch_size=32, work_num=4, return_sample_ids=False,
    ...
    print("Chapman loaded:", X.shape, "labels/class:", Y.sum(0).astype(int).tolist())
    if remove_baseline:
